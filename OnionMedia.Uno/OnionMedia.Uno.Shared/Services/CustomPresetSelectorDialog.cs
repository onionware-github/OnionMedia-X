...
namespace OnionMedia.Services
{
    sealed class CustomPresetSelectorDialog : ICustomPresetSelectorDialog
    {
        ...
        {
            Uno.Views.Dialogs.CustomPresetSelectorDialog dlg = new() { XamlRoot = UIResources.XamlRoot };
        ...
        {
            Uno.Views.Dialogs.CustomPresetSelectorDialog dlg = new(customOptions) { XamlRoot = UIResources.XamlRoot };
            return await dlg.ShowAsync() == ContentDialogResult.Primary
                ? (dlg.UseCustomOptions, dlg.ConversionPreset)
                : null;
        }
